...
namespace Lab4
{
    class Lab4
    {
        ...
        public static void ProcessorArchitecture(ushort wProcessorArchitecture)
        {
            ...
            {
                case 0:
                    Console.WriteLine("PROCESSOR_ARCHITECTURE_INTEL: x86");
                    break;
                case 5:
                    Console.WriteLine("PROCESSOR_ARCHITECTURE_ARM: ARM");
                    break;
                case 6:
                    Console.WriteLine("PROCESSOR_ARCHITECTURE_IA64: Intel Itanium - based");
                    break;
                case 9:
                    Console.WriteLine("PROCESSOR_ARCHITECTURE_AMD64: x64(AMD or Intel)");
                    break;
               
                case 12:
                    Console.WriteLine("PROCESSOR_ARCHITECTURE_ARM64: ARM64");
                    break;
                default:
                    Console.WriteLine("PROCESSOR_ARCHITECTURE_UNKNOWN: Unknown architecture");
                    break;
            }
        }
